...
from tubular.strings import LowerCaseTransformer


class TestLowerCaseTransformerInit(
    ColumnStrListInitTests,
):
    """Tests for LowerCaseTransformer initialization."""

    @classmethod
    def setup_class(cls):
        cls.transformer_name = "LowerCaseTransformer"


class TestLowerCaseTransformerTransform(GenericTransformTests):
    "tests for LowerCaseTransformer.transform"
    ...
    def test_multi_column_output(self, lazy, library, from_json):
        ...
        transformer = LowerCaseTransformer(columns=["a", "b"])
...
class TestOtherBaseBehaviour(OtherBaseBehaviourTests):
    """
    Class to run tests for LowerCaseTransformer outside the three standard methods.
